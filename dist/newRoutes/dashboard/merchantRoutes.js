...
import { merchantDashboardValidation, } from "../../validators/dashboard/index.js";
const merchantRoutes = Router();
// Define routes using arrow functions
merchantRoutes.get("/merchant", [isLoggedIn, ...merchantDashboardValidation], authorize("Dashboard"), dashboardController.merchantDashboardDetails);
