...
import { authorize, blockPhoneMiddleware, checkOtp, isLoggedIn } from "../../utils/middleware.js";
...
router.post("/pay-otp", [block_phone_number_middleware.blockPhoneNumberInRedirection, blockPhoneMiddleware, checkOtp], paymentRequestController.payRequestedPaymentForRedirection);
...
router.put("/:paymentRequestId", [isLoggedIn], authorize("Invoice Link"), paymentRequestController.updatePaymentRequest);
router.delete("/:paymentRequestId", [isLoggedIn], authorize("Invoice Link"), paymentRequestController.deletePaymentRequest);
