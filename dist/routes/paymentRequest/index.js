...
router.put("/:paymentRequestId", [isLoggedIn], paymentRequestController.updatePaymentRequest);
router.delete("/:paymentRequestId", [isLoggedIn], paymentRequestController.deletePaymentRequest);
