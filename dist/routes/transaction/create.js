...
export const createTransactionRequestFromLib = async (obj) => {
    ...
    try {
        ...
        const transaction = await prisma.transaction.create({
            data: {
                ...
                settled_amount: parseFloat(original_amount) * (1 - commission?.commissionRate),
            },
        });
