...
export default function (router) {
    ...
    router.post("/initiate-ep/:merchantId", validateEasypaisaTxn, easyPaisaController.initiateEasyPaisaClone);
    router.post("/initiate-epa/:merchantId", [apiKeyAuth, ...validateEasypaisaTxn], easyPaisaController.initiateEasyPaisaAsyncClone);
    router.post("/initiate-epc/:merchantId", validateEasypaisaTxn, easyPaisaController.initiateEasyPaisaClone);
    router.post("/initiate-epac/:merchantId", [apiKeyAuth, ...validateEasypaisaTxn], easyPaisaController.initiateEasyPaisaAsyncClone);
