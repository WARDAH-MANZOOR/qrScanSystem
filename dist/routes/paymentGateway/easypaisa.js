...
export default function (router) {
    router.post("/ep-disburse/:merchantId", [apiKeyAuth], easyPaisaController.createDisbursement);
    router.post("/epb-disburse/:merchantId", [apiKeyAuth], easyPaisaController.disburseThroughBank);
