...
const dateFilter = async () => {
    ...
    const startOfTodayInPKT = new Date(nowInPKT.getFullYear(), nowInPKT.getMonth(), nowInPKT.getDate());
...
async function processMerchantSettlement(tx, merchant_id, transactions, merchantFinancialTerms, transactionIdToTaskIdMap) {
    try {
        ...
        let deductionSourceTxns = originalDeductionSourceTxns.filter((txn) => txn.providerDetails.deduction != null);
