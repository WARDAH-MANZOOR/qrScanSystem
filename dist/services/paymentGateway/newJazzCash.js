...
export function calculateHmacSha256(json, integrityText) {
    try {
...
const newInitiateJazzCashPayment = async (paymentData, merchant_uid) => {
    let refNo = "";
    try {
...
const newInitiateJazzCashCnicPayment = async (paymentData, merchant_uid) => {
    let refNo = "";
    try {
...
const newStatusInquiry = async (payload, merchantId) => {
