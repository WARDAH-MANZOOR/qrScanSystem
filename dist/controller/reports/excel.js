...
const generateExcelReportController = async (req, res, next) => {
    try {
...
const payinPerWalletController = async (req, res, next) => {
    try {
        // Call the service method
        const params = req.query;
...
const payoutPerWalletController = async (req, res, next) => {
    try {
        // Call the service method
        const params = req.query;
